...
# test BCs
'''
bc_x0 = {'type': 'dirichlet', 'function': lambda x, y: 0}
bc_x1 = {'type': 'dirichlet', 'function': lambda x, y: 5*y}
bc_y0 = {'type': 'dirichlet', 'function': lambda x, y: 0}
bc_y1 = {'type': 'dirichlet', 'function': lambda x, y: 5*x}
'''
